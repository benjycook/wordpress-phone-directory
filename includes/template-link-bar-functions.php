...
echo '<li><a class="button secondary" href="http://'.$url.'" target="_blank" rel="nofollow"><i class="fi-laptop"></i> '.__('Website','phone-dir').'</a> </li>';
}
...
echo '<li>
<a class="button secondary" href="https://www.google.com/maps/dir/Current+Location/'. $mapStreet.'+'.$mapCity.'+'.$mapPostcode.'" target="_blank"><i class="fi-marker"></i> '. __('Directions','phone-dir').'</a>
</li>';
