<?php
/*
Title: Sinlge Directory
Setting: simple_directory_settings
Tab: Layout
Sub Tab: Single Directory
Flow: SDIR Workflow
Default: true
*/
...
piklist ('field', array(
 ...
 ,'label'=>__('Show Theme Sidebar on Single Listing?','phone-dir')
 ,'attributes' => array(
   'class' => 'text'
   )
 ,'choices' =>array(
...
piklist('field',array(
  ...
  ,'description' =>__('Add a class to the top-level &lt;div&gt; on the single lisitngs.','phone-dir')
...
piklist('field',array(
  ...
  //,'label'=>__('Global Compatibility','phone-dir')
  ,'value'=>'<hr/>'
